...
def grabData(self, windowAddress):
    ...
    print("Name " + str(product_json["name"]) + "\nAsin: " + str(product_json["asin"]) + "\nLong reviews: " + str(product_json["long-reviews"]) + "\n")
    

# Grabs the animal text from user input and number of pics we'll use
windowAddress = "https://www.amazon.com/EVIL-ENERGY-Exhaust-Muffler-Universal/dp/B01N6EIB3B/ref=sr_1_3?keywords=muffler&qid=1582468234&sr=8-3"
product_json = {}
